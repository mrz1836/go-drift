...
Security is a priority. We maintain a proactive stance to identify and fix vulnerabilities in **go-drift**.

<br/>

## 🛠️ Supported & Maintained Versions
Any released version of **go-drift** that is not marked as deprecated is actively supported and maintained.
